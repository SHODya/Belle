            ...
            <div class="container">
                <div class="menu ">
                    ...
                    <nav class="navbar-brand">
                        <a href="index.html"><img src="images/BelleLogo.png"></a>

                    </nav>
                <div class="menu">
                    <nav class="nav-item btn">
                        <img class="nav-img" src="images/Heart.png">
                        <img class="nav-img" src="images/Bag.png">
            ...
            <div class="bottomInfo">
                <div class="bottomInfos">
                    ...
                    <div class="margin-12">
                        ...
                        <p class="infoItem Inter">Belle - это комфортный интернет-шопинг и 31 розничный магазин. 14 лет мы выпускаем одежду <br> в стиле сasual для любых ситуаций, времени года и погоды, помогая покупателям создать<br> свой собственный, неповторимый образ.</p>
                    </div>
                </div>
            </div>
