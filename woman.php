            ...
            <div class="inl-block wrap">
                ...
                <div id="new" class="popular">
                    ...
                    <div class="popular-blocks">
                        ...
                        <div class="popular-block">
                            ...
                            <a href="product.php" class="BlueCurve nav-link margin-12">13990 тг</a>
                        </div>
                        <div class="popular-block">
                            <a href="index.html"><img src="images/womanNew2.jpg" class="popular-img"></a>
                            <button id="heartVoid3" class="item-fav3 fav-btn"><i class="fa-solid fa-heart"
                                    onclick="changeImage(this)"></i></button>
                            <a href="" class="Inter nav-link margin-12">Рубашка из фланели в клетку</a>
                            <a href="" class="BlueCurve nav-link margin-12">13990 тг</a>
                        </div>
                    </div>
                </div>
                ...
                <div id="categories" class="five-img-block margin-left-11pr">
                    <div class="inl-block">
                        ...
                        <div class="three-img">
                            <img class="" src="images/womanPants.jpg" alt="">
                            <p class="">Брюки</p>
                        </div>
                        <div class="three-img">
                            <img class="" src="images/womanSweaters.jpg" alt="">
                            <p class="">Джемперы</p>
                        </div>
                    </div>
                ...
                <div id="popular" class="popular margin-left-19pr">
                    ...
                    <div class="popular-blocks">
                        ...
                        <div class="popular-block">
                            <a href="index.html"><img src="images/womanJacket.jpg" class="popular-img"></a>
                            <button id="heartVoid2" class="item-fav2 fav-btn"><i class="fa-solid fa-heart"
                                    onclick="changeImage(this)"></i></button>
                            <a href="" class="Inter nav-link margin-12">Однобортый жакет в полоску</a>
                            <a href="" class="BlueCurve nav-link margin-12">23990 тг</a>
                        </div>
                        <div class="popular-block">
                            <a href="index.html"><img src="images/womanJamper.jpg" class="popular-img"></a>
                            <button id="heartVoid3" class="item-fav3 fav-btn"><i class="fa-solid fa-heart"
                                    onclick="changeImage(this)"></i></button>
                            <a href="" class="Inter nav-link margin-12">Джемпер в полоску</a>
                            <a href="" class="BlueCurve nav-link margin-12">13990 тг</a>
                        </div>
                    </div>
                </div>
